...
<html lang="en">
  ...
  <body>
    <div class="jumbotron jumbotron-fluid">
      <div class="container">
        <h1 class="display-4">Nofikasi User</h1>
          ...
          <div class="row">
            <div class="col">
              <div class="text-center">
                <div class="row mb30">
                  <div class="col">
                    <img width="200px" src="https://nucare.id/_nuxt/img/empty-overview.0ed5b91.png" class="lazyLoad isLoaded">
                  </div></div> 
                  <div class="row mb30">
                    <div class="col-6 mx-auto">
                      <h5 class="text-3c fontsize-24">Belum ada notifkasi terbaru</h5>
                    </div>
                  </div>
                </div>
      </div>
