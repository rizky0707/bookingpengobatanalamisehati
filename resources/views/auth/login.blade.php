...
<html lang="en">
  <head>
    ...
    <title>Login - Pengobatan Alami Sehati</title>
    <!-- plugins:css -->
  ...
  <body>
    ...
    @endif
                <h4>Hello! sobat Alami Sehati</h4>
                ...
                @enderror 
                  ...
                  <div class="text-center mt-4 font-weight-light"> Registrasi terlebih dahulu ? <a href="{{route('register')}}" class="text-primary">Create</a>
                  </div>
                </form>
              </div>
            </div>
