      ...
      <div class="col-lg-12 grid-margin stretch-card">
        ...
        <div class="row">
            ...
            <table id="example" class="table table-bordered table-responsive">
              ...
              <tbody>
                <?php $no= 1; ?>
                @foreach ($bookings_rawat_jalan as $item) 
                <tr>  
                <td> {{$no++}} </td>
            ...
            <a href="{{ route('rawatJalan.create', ['booking_id' => $item->id]) }}" class="btn btn-success btn-sm">
        ...
        <td> {{$item->user->name}} </td>
          ...
          <td>
                <form action="#" method="POST">
                  ...
                  <a href="{{route('createDiagnosa')}}" class="btn btn-success btn-sm"><i class="mdi mdi-pencil-box-outline"></i>Diagnosa</a> 
                </form>
          </td>  
        </tr>
        @endforeach
